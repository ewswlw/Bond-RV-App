...
- Use this guide when mapping securities across systems or ensuring historical accuracy in Portfolio123 projects.
- Apply it before importing data, reconciling identifiers, or handling delisted stocks to avoid survivorship bias.
- Reference it when APIs or screens require specific identifier types (Ticker vs FIGI vs StockID).
- Consult it during troubleshooting of mismatched or missing securities; the guide outlines best practices and supported IDs.
- For casual ticker lookups, quick references may suffice; rely on this document for robust multi-identifier workflows.
