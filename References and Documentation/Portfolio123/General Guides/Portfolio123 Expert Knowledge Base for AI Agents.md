...
- Use this knowledge base when training or guiding AI agents to operate Portfolio123 end-to-end—from factor lookup to rule construction and automation.
- Apply it before deploying assistants in user-facing contexts so they understand the modular guides and how to translate plain-English requests into Portfolio123 syntax.
- Reference it during onboarding of new team members who need a curated map of all supporting documentation.
- Consult it when designing workflows; the example agent process demonstrates how modules fit together in real tasks.
- For human quick reference, shorter guides may suffice; this document is the canonical master index for AI enablement.
