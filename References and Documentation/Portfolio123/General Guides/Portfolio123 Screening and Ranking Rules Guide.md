...
- Use this guide when translating investment criteria into Portfolio123 screen or ranking formulas.
- Apply it before building or editing rules to ensure syntax, operators, and pattern examples are used correctly.
- Reference it while coaching analysts; it includes both wizard-based and code-based workflows.
- Consult it during QA of existing strategies to verify logical structure, grouping, and composite weights.
- For quick factor lookups, pair it with the quick reference card; for full rule construction, rely on this guide.
