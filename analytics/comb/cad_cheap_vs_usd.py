...
def run_analysis(
    ...
    # Separate into CAD and USD CUSIPs
    ...
    print(f"Found {len(cad_cusips)} CAD CUSIPs and {len(usd_cusips)} USD CUSIPs with valid data")
    ...
    print("Pre-filtering pairs where CAD/USD pairs have matching Tickers, Custom_Sectors, and Yrs (Cvn) difference <= 2...")
    ...
    print(f"Found {num_pairs:,} valid pairs (out of {len(cad_cusips) * len(usd_cusips):,} possible CAD/USD combinations)")
